...
let handler = async (m, { conn }) => {
  let pepe = 'https://telegra.ph/file/6e7fcb7663743ecc18bc5.jpg'
  let baper = await fetch(pepe).then(a => a.buffer())

  let aine = '6289616866270@s.whatsapp.net'
...
`,
  ...
  jpegThumbnail: baper },
  businessOwnerJid: `6289616866270@s.whatsapp.net`
  },
  footerText: 'sumei.site',
  }},{})
